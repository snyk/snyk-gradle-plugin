...
test('multi-project, explicitly targeting a subproject build file', function (t) {
  t.plan(2);
  return plugin.inspect('.',
    path.join(__dirname, '..', 'fixtures', 'multi-project', 'subproj', 'build.gradle'))
    .then(function (result) {
...
test('multi-project, ran from root, targeting subproj', function (t) {
  t.plan(2);
  return plugin.inspect(
    path.join(__dirname, '..', 'fixtures', 'multi-project'),
...
test('multi-project, ran from a subproject directory', function (t) {
  t.plan(2);
  return plugin.inspect(
    path.join(__dirname, '..', 'fixtures', 'multi-project', 'subproj'),
    'build.gradle')
    .then(function (result) {
